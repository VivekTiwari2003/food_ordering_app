...
function Cart() {
  ...
  return (
    <>
    <div className={`fixed right-0 top-0 w-full lg:w-[20vw] bg-white h-full p-5 bg-white mb-3 ${activeCart ? "translate-x-0" : "translate-x-full"} transition-all duration-500 z-50`}>
...
{/* <ItemCard/> */}
    <div className='absolute bottom-0'>
      ...
      <button onClick={()=>navigate("/success")} className='bg-green-500 font-bold px-3 text-white py-2 rounded-lg w-[90vw] lg:w-[18vw] ab-5'>Checkout</button>
    </div>
    </div>
